...
var generatedPlatforms = map[string]PlatformDefinition{
	"claude": {
		...
		Files: []TemplateFile{
			...
			{Path: ".claude-plugin/plugin.json", Template: "plugin.json.tmpl", Extra: false},
			{Path: "hooks/hooks.json", Template: "hooks.json.tmpl", Extra: false},
	...
	"codex": {
		...
		Files: []TemplateFile{
			...
			{Path: ".codex/config.toml", Template: "codex.config.toml.tmpl", Extra: false},
