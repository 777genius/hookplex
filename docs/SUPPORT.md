...
- experimental `hookplex skills` authoring/render subsystem and generated skill artifacts
...
- `hookplex skills init`
- `hookplex skills validate`
- `hookplex skills render`
...
Handwritten `SKILL.md` is supported; `hookplex skills init` is convenience scaffold only, not a required authoring path.
