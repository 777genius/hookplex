...
- Gemini: packaging-only Gemini CLI extension target through `plugin-kit-ai render|import`; not a production-ready runtime target
...
- Gemini packaging-only Gemini CLI extension target through `plugin-kit-ai render|import`
