...
| Cursor workspace lane | done | Documented Cursor MCP + rules subset now has generate/import/validate coverage, optional shared `AGENTS.md` support, and an explicit deferred-scope boundary for `CLAUDE.md`, global MCP, nested rules, and JSONC. |
