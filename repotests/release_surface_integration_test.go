...
func TestReleaseSurface_MakefileDocsAndWorkflowsStayAligned(t *testing.T) {
	...
	mustContain(t, liveWorkflow, "echo \"NPM_GLOBAL_PREFIX=${prefix}\" >> \"$GITHUB_ENV\"")
	mustContain(t, liveWorkflow, "echo \"${NPM_GLOBAL_PREFIX}/bin\" >> \"$GITHUB_PATH\"")
	mustContain(t, liveWorkflow, "npm i -g \"plugin-kit-ai@${version}\"")
	mustContain(t, liveWorkflow, "\"${NPM_GLOBAL_PREFIX}/bin/plugin-kit-ai\" version")
