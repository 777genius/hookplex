...
func TestContractClarity_RuntimeMetadataAndDocsStayAligned(t *testing.T) {
	...
	mustContain(t, string(pluginsExamplesReadme), "[cursor-basic](./cursor-basic): Cursor workspace-config repo with `plugin.yaml`, generated `.cursor/mcp.json`, mirrored `.cursor/rules/**`, and optional shared root `AGENTS.md`")
