...
func TestContractClarity_RuntimeMetadataAndDocsStayAligned(t *testing.T) {
	...
	mustContain(t, matrix, "Gemini runtime hooks appear here alongside Claude and Codex")
	mustContain(t, matrix, "| gemini | SessionStart | runtime_supported | stable | production-ready | true |")
	mustContain(t, matrix, "| gemini | BeforeToolSelection | runtime_supported | stable | production-ready | true |")
	...
	mustContain(t, string(sdkStabilityDoc), "approved exported Gemini helper constructors for the stable subset")
	...
	mustContain(t, string(cliReadme), "Gemini supports packaging-only authoring by default and a production-ready Go runtime lane via `--platform gemini --runtime go`.")
	mustContain(t, string(cliReadme), "Gemini defaults to launcher-less packaging but also supports `--runtime go` for the production-ready runtime lane")
	...
	mustContain(t, string(cliReadme), "deterministic repo-local runtime gating via `make test-gemini-runtime` and dedicated opt-in real CLI runtime smoke via `make test-gemini-runtime-live`")
	...
	mustContain(t, string(supportDoc), "Gemini: production-ready Go runtime for `SessionStart`, `SessionEnd`, `BeforeModel`, `AfterModel`, `BeforeToolSelection`, `BeforeAgent`, `AfterAgent`, `BeforeTool`, and `AfterTool`; full Gemini CLI extension packaging remains first-class")
	...
	mustContain(t, string(patchRehearsalDoc), "Gemini production-ready Go runtime for `SessionStart`, `SessionEnd`, `BeforeModel`, `AfterModel`, `BeforeToolSelection`, `BeforeAgent`, `AfterAgent`, `BeforeTool`, and `AfterTool`")
	...
	mustContain(t, string(makefile), "^TestGeminiCLIRuntime(Hooks|BeforeToolDeny|BeforeModelDeny|DisableAllTools)")
