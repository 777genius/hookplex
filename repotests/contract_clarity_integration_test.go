...
func TestContractClarity_RuntimeMetadataAndDocsStayAligned(t *testing.T) {
	...
	mustContain(t, matrix, "Gemini stable and beta hooks appear here alongside Claude and Codex")
	mustContain(t, matrix, "| gemini | SessionStart | runtime_supported | stable | production-ready | true |")
	mustContain(t, matrix, "| gemini | BeforeToolSelection | runtime_supported | stable | production-ready | true |")
	...
	mustContain(t, string(sdkStabilityDoc), "approved exported Gemini helper constructors that remain beta")
	...
	mustContain(t, string(architectureDoc), "Gemini stable and beta hooks use `stdin_json`")
	...
	mustContain(t, string(rootReadme), "overview: [plugin-kit-ai documentation](https://777genius.github.io/plugin-kit-ai/docs/en/)")
	mustContain(t, string(rootReadme), "fastest start: [Quickstart](https://777genius.github.io/plugin-kit-ai/docs/en/guide/quickstart.html)")
	mustContain(t, string(rootReadme), "one repo, many outputs: [What You Can Build](https://777genius.github.io/plugin-kit-ai/docs/en/guide/what-you-can-build.html)")
	mustContain(t, string(rootReadme), "honest caveat: [Support Boundary](https://777genius.github.io/plugin-kit-ai/docs/en/reference/support-boundary.html)")
	...
	mustContain(t, string(cliReadme), "Gemini supports packaging-only authoring by default and a Go runtime lane via `--platform gemini --runtime go`; that lane now includes a production-ready stable subset plus advisory beta remainder.")
	mustContain(t, string(cliReadme), "Gemini defaults to launcher-less packaging but also supports `--runtime go` for the stable subset plus advisory beta remainder")
	...
	mustContain(t, string(cliReadme), "deterministic repo-local production gating via `make test-gemini-runtime-prod`, broader full-lane smoke via `make test-gemini-runtime-smoke`, and dedicated opt-in real CLI runtime smoke via `make test-gemini-runtime-prod-live`")
	...
	mustContain(t, string(pluginsExamplesReadme), "make test-gemini-runtime-prod-live")
	...
	mustContain(t, string(supportDoc), "Gemini: production-ready within the stable Go subset")
	...
	mustContain(t, string(supportDoc), "Gemini beta advisory remainder:")
	mustContain(t, string(supportDoc), "dedicated opt-in real CLI runtime smoke")
	mustContain(t, string(supportDoc), "Gemini stable and beta hooks, plus the Claude/Codex runtime lanes, appear there")
	...
	mustContain(t, string(productionDoc), "matching opt-in real CLI runtime smoke")
	...
	mustContain(t, string(hardeningDoc), "Gemini now has a production-ready stable Go subset for `SessionStart`, `SessionEnd`, `BeforeModel`, `AfterModel`, `BeforeToolSelection`, `BeforeAgent`, `AfterAgent`, `BeforeTool`, and `AfterTool`, while `Notification` and `PreCompress` remain `public-beta`")
	...
	mustContain(t, string(patchRehearsalDoc), "Gemini stable Go runtime subset for `SessionStart`, `SessionEnd`, `BeforeModel`, `AfterModel`, `BeforeToolSelection`, `BeforeAgent`, `AfterAgent`, `BeforeTool`, and `AfterTool`")
	mustContain(t, string(patchRehearsalDoc), "Gemini `Notification` and `PreCompress` remain outside the stable runtime promise")
	...
	mustContain(t, string(makefile), "test-gemini-runtime-prod:")
	...
	mustContain(t, string(makefile), "TestGeminiE2ETraceCapturesStableSubsetLifecycleHooks")
	mustContain(t, string(makefile), "TestGeminiE2ETraceCapturesStableRuntimeControlSemantics")
	mustContain(t, string(makefile), "test-gemini-runtime-prod-live:")
