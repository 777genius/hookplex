...
func TestContractClarity_RuntimeMetadataAndDocsStayAligned(t *testing.T) {
	...
	mustContain(t, string(rootReadme), "Fast starter repos: [examples/starters/README.md](examples/starters/README.md)")
	mustContain(t, string(rootReadme), "Reference repos: [examples/local/README.md](examples/local/README.md)")
	mustContain(t, string(rootReadme), "Official starter templates:")
	mustContain(t, string(rootReadme), "https://github.com/777genius/plugin-kit-ai-starter-codex-python")
	mustContain(t, string(rootReadme), "https://github.com/777genius/plugin-kit-ai-starter-codex-node-typescript")
	mustContain(t, string(rootReadme), "https://github.com/777genius/plugin-kit-ai-starter-claude-python")
	mustContain(t, string(rootReadme), "https://github.com/777genius/plugin-kit-ai-starter-claude-node-typescript")
	...
	mustContain(t, string(rootReadme), "`examples/starters`: copy-first Python/Node starter repos")
	...
	mustContain(t, string(startersExamplesReadme), "copy-first entrance for the stable Python/Node subset")
	mustContain(t, string(startersExamplesReadme), "canonical source of truth")
	...
	mustContain(t, string(pluginsExamplesReadme), "For copy-first Python/Node starter repos, see [../starters/README.md](../starters/README.md).")
	mustContain(t, string(pluginsExamplesReadme), "For deeper repo-local Python/Node entrance references, see [../local/README.md](../local/README.md).")
