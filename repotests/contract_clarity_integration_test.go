...
func TestContractClarity_RuntimeMetadataAndDocsStayAligned(t *testing.T) {
	...
	mustContain(t, string(interpretedPromotionDoc), "official downstream CLI availability through Homebrew, `scripts/install.sh`, and `777genius/plugin-kit-ai/setup-plugin-kit-ai@v1`")
