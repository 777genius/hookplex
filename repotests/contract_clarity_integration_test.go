...
func TestContractClarity_RuntimeMetadataAndDocsStayAligned(t *testing.T) {
	...
	mustContain(t, string(rootReadme), "The official Python ecosystem path is `pipx install plugin-kit-ai` or `pipx run plugin-kit-ai version`")
	...
	mustContain(t, string(cliReadme), "official pipx CLI bootstrap (`public-beta`)")
	...
	mustContain(t, string(supportDoc), "`pipx install plugin-kit-ai` or `pipx run plugin-kit-ai version` is the official Python ecosystem path")
	...
	mustContain(t, string(supportDoc), "local Python ecosystem install path uses `pipx install plugin-kit-ai` as `public-beta`")
	...
	mustContain(t, string(supportDoc), "PyPI publishes come from the current repo's release automation")
	...
	mustContain(t, string(productionDoc), "use `pipx install plugin-kit-ai` as the official `public-beta` Python ecosystem path")
	...
	mustContain(t, string(pypiPublishWorkflow), "types: [published]")
	...
	mustContain(t, string(abiDoc), "The official Python ecosystem path is `pipx install plugin-kit-ai` or `pipx run plugin-kit-ai version`; this wrapper stays `public-beta`")
