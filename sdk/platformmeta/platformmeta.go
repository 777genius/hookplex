	...
	return []PlatformProfile{
		...
		},
		{
			...
			Contract: TargetContractMeta{
				...
				Summary:                "Gemini compiles as an official-style extension package with MCP, a primary root context, target-native extension assets, and a production-ready Go stable subset plus beta advisory remainder.",
			},
			SDK: SDKMeta{
