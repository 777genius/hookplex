...
func renderSupportMatrix(m model) string {
	...
	b.WriteString("This generated table is the canonical per-event runtime support contract for shipped runtime claims. Runtime-supported Gemini beta hooks appear here alongside Claude and Codex; packaging-only or workspace-config-only targets remain documented in SUPPORT.md.\n\n")
