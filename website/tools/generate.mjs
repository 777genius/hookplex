...
function localeLabels(locale) {
  if (locale === "ru") {
    return {
      guide: "Гайды",
      guideStart: "Первые шаги",
      guideCoreIdea: "Модель проекта",
      guideBuild: "Основные пути сборки",
      guideStarters: "Starter'ы, примеры и рецепты",
      guideDelivery: "Поставка, target'ы и миграция",
      guideOperate: "Работа в команде",
      guideOverview: "Обзор",
      ...
      referenceSupport: "Граница поддержки",
      referenceHelp: "FAQ и диагностика",
  ...
  return {
    guide: "Guide",
    guideStart: "First Steps",
    guideCoreIdea: "Project Model",
    guideBuild: "Core Build Paths",
    guideStarters: "Starters, Examples, And Recipes",
    guideDelivery: "Delivery, Targets, And Migration",
    guideOperate: "Team Operations",
    ...
    referenceSupport: "Support Boundary",
    referenceHelp: "FAQ And Troubleshooting",
