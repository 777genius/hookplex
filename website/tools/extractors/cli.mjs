...
function localizeCliMarkdown(locale, body) {
  ...
  const replacements = [
    ...
    ["Use plugin-kit-ai import to migrate current Claude/Codex/Gemini/OpenCode/Cursor native files into the package-standard authored layout.", "Используйте `plugin-kit-ai import`, чтобы перенести текущие нативные файлы Claude/Codex/Gemini/OpenCode/Cursor в authored layout package-standard проекта."],
