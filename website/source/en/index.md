...
- Team lead or maintainer: start with [Team Adoption](/en/guide/team-adoption), [Team-Scale Rollout](/en/guide/team-scale-rollout), and [CI Integration](/en/guide/ci-integration).
...
<div class="docs-grid">
  ...
  <a class="docs-card" href="./guide/team-scale-rollout">
    <h2>I Roll Changes Across Several Repos</h2>
    <p>Start here when the work is no longer one repo at a time, but coordinated rollout of new defaults and release guidance.</p>
  </a>
