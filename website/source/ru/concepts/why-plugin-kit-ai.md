...
Вы получаете более сильную структуру, более ясные границы и более предсказуемые workflow. Одна из главных ценностей продукта в том, что команде не нужно выбирать между "один repo" и "несколько target’ов", если продукту нужны оба свойства одновременно.
