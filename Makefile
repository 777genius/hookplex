...
test-gemini-runtime-smoke:
	...
	go test -count=1 -run 'TestPluginKitAIInitGeminiGoRuntimeLauncherFlow|TestGeneratedConfigCanaries_GeminiBetaHookSubsetAndCommandShape|TestGeminiE2ETracePreservesOriginalRequestName|TestGeminiE2ETraceCapturesModelAndToolSelectionPayloads|TestGeminiE2ETraceCapturesLifecycleAndAdvisoryHooks' ./repotests $(EXTENDED_TEST_ARGS)
