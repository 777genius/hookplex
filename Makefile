...
test-gemini-runtime-smoke:
	...
	go test -count=1 -run 'TestPluginKitAIInitGeminiGoRuntimeLauncherFlow|TestGeneratedConfigCanaries_GeminiBetaHookSubsetAndCommandShape|TestContractClarity_RuntimeMetadataAndDocsStayAligned|TestGeminiE2ETracePreservesOriginalRequestName|TestGeminiE2ETraceCapturesModelAndToolSelectionPayloads' ./repotests $(EXTENDED_TEST_ARGS)
