...
test-polyglot-smoke:
	...
	go test -count=1 -run 'TestBundleInstall(HelpIncludesLocalTarballLanguage|WritesRunnerOutput)$$' ./cli/plugin-kit-ai/cmd/plugin-kit-ai
	...
	go test -count=1 -run 'TestPluginKitAIExport(PythonRequirementsBundleFlow|NodeTypeScriptBundleFlow|ShellBundleFlow)|TestPluginKitAIBundleInstall(PythonRequirementsFlow|NodeTypeScriptFlow)$$' ./repotests
