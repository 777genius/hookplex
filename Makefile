...
test-gemini-runtime-live:
	PLUGIN_KIT_AI_RUN_GEMINI_RUNTIME_LIVE=1 go test -count=1 -run '^TestGeminiCLIRuntime(Hooks|BeforeToolDeny|BeforeModelDeny|DisableAllTools)$$' ./repotests $(EXTENDED_TEST_ARGS)
