...
- [cursor-basic](./cursor-basic): Cursor workspace-config repo with `plugin.yaml`, generated `.cursor/mcp.json`, mirrored `.cursor/rules/**`, and optional shared root `AGENTS.md`
...
Their authored source of truth is `plugin.yaml` plus `targets/<platform>/...`; committed native Claude/Codex/Gemini/Cursor/OpenCode files are generated managed artifacts.
